      ...
      <div>
        <div className="row around-sm">
          <div className="col-sm-4" style={{ marginTop: 30 }}>
            <RecordVoice onSpeech={this.onSpeech} toggleRunning={this.toggleRunning} />
          </div>
                ...
                <div className="box">
                  {
                    this.state.showOverallReport ?
                      <Modal
                        ...
                        onClose={() => this.setState({ showOverallReport: false })}
                        showCloseIcon={false}
                      >
                        <OverallReport totalSentiments={this.state.overallSentimentData} />
                      </Modal> :
                      <Button style={{ marginTop: 30 }} variant="raised" onClick={this.showOverallReport}>Show Overall Report</Button>
                  }
                </div>
              </div>
            </div>
          ...
          <div className="col-sm-4" style={{ marginTop: 30 }}>
            <Camera updateEmotion={this.updateEmotion} running={this.state.running} />
          </div>
        </div>
